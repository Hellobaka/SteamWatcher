...
using me.cqp.luohuaming.SteamWatcher.Core;
using me.cqp.luohuaming.SteamWatcher.Core.Domain;
using me.cqp.luohuaming.SteamWatcher.Sdk.Cqp;
using me.cqp.luohuaming.SteamWatcher.Sdk.Cqp.Enum;
using me.cqp.luohuaming.SteamWatcher.Sdk.Cqp.EventArgs;
using me.cqp.luohuaming.SteamWatcher.Sdk.Cqp.Interface;
using me.cqp.luohuaming.SteamWatcher.Sdk.Cqp.Expand;
using me.cqp.luohuaming.SteamWatcher.Sdk.Cqp.Model;
using Unity;
using Unity.Injection;

namespace me.cqp.luohuaming.SteamWatcher.App.Export
{
	/// <summary>	
	/// 表示酷Q事件导出的类	
	/// </summary>	
	...
	{	
		...
		{	
			return "9,me.cqp.luohuaming.SteamWatcher";	
		}	
		...
		{	
			...
			Type appDataType = typeof (AppData);	
			// 注册一个 CQApi 实例	
			AppInfo appInfo = new AppInfo ("me.cqp.luohuaming.SteamWatcher", 1, 9, "酷Q样例应用 for C#", "1.0.0", 1, "JieGG", "酷Q样例应用(V9应用机制)", authCode);	
			...
			AppData.UnityContainer.RegisterInstance<CQLog> ("me.cqp.luohuaming.SteamWatcher", AppData.CQLog);	
